...
with create_ssh_tunnel() as server:
    ...
    try:
        with conn.cursor() as cur:
            ...
            # 2. Breakdown counts for Platinum in Group B
            print(f'Breaking down Platinum duplicate counts in Group B...')
            ...
            for i in range(0, len(group_b_uids), chunk_size):
                ...
                sql = f"""
                    ...
                    WHERE o.uid IN ({placeholders})
                      ...
                      AND s.name IN ('Platinum monthly', 'Platinum yearly')
            ...
            print('\nGroup B Platinum Duplicate Count Distribution:')
