    ...
    try:
        with conn.cursor() as cur:
            ...
            for i in range(0, len(group_a_uids), chunk_size):
                ...
                # Careful logic: 
                # We count DISTINCT subscribe_id that satisfy the condition.
                # Since multiple orders share subscribe_id, if ANY order for that sub_id matches the desc, it counts.
                # And since they usually duplicate exactly, checking the row is fine.
            ...
            print('\nGroup A Trial Distribution (Filtered by Desc):')
